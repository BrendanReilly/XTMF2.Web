...
namespace XTMF2.Web.Server.Controllers {
    ...
    public class ModelSystemController : ControllerBase {
        ...
        public ModelSystemController (XTMFRuntime runtime, ILogger<ModelSystemController> logger,
            IMapper mapper) {
        ...
        /// <summary>
        /// Deletes a the specified model system.
        /// </summary>
        /// <param name="projectName"></param>
        /// <param name="modelSystemName"></param>
        /// <param name="user"></param>
        /// <returns></returns>
        [HttpDelete ("project/{projectName}/model-system/{modelSystemName}")]
        ...
        public ActionResult Delete (string projectName, string modelSystemName, [FromServices] User user) {
            ...
            if (!projectSession.RemoveModelSystem (user, modelSystemHeader, ref error)) {
        ...
        /// <param name="user"></param>
        /// <returns></returns>
        [HttpGet ("project/{projectName}/model-system/{modelSystemName}")]
        [ProducesResponseType (StatusCodes.Status404NotFound)]
